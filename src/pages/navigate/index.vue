<template>
  <div class="info-table">
    ...
    <el-table
      :data="tableData.filter(data => !search || data.anchorName.toLowerCase().includes(search.toLowerCase()))"
      style="width: 100%;"
    ...
    <el-dialog title="专家列表管理" :visible.sync="dialogFormVisible"  width="420px">
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item label="头像" :label-width="formLabelWidth">
          ...
          <img :src="form.userIcon" width="100px" v-if="form.userIcon !== ''">
        </el-form-item>
        <el-form-item label="专家名称" :label-width="formLabelWidth" prop="userName">
          <el-input v-model="form.userName" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        <el-form-item label="描述" :label-width="formLabelWidth" prop="userDesc">
          <el-input v-model="form.userDesc" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        <el-form-item label="粉丝" :label-width="formLabelWidth" prop="follows">
          <el-input v-model="form.follows" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
      </el-form>
