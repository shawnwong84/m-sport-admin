<template>
    <div class="info-table">
        ...
        >
            ...
            <el-table-column prop="exchangeCode" label="生成的兑换码">
            </el-table-column>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            expList: [],
            rules: {
                codeNums: [{ validator: checSort, trigger: 'blur' }],
            },
            tableTitleData: [
                {
                    label: 'ID',
