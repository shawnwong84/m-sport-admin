    ...
    <div>
        <div class="info-table">
            <div class="fx align-items justify-between mt-15 mb-15 ml-10 mr-10">
                <div class="fs-18 fw-600">运营统计</div>
                <div class="fx">
                    <div
                        class="cx-box"
                        :class="checkBox === 1 ? 'xz' : ''"
            ...
            <div class="fx align-items fx-end mb-15" v-if="checkBox === 1">
                ...
                <el-button
                    ...
                    size="small"
                    icon="el-icon-plus"
                    @click="getNowInfo(date[0], date[1], channel)"
                    >查询</el-button
                >
            </div>
            <div class="fx align-items fx-end mb-15" v-if="checkBox === 2">
                ...
                <el-button
                    ...
                    size="small"
                    icon="el-icon-plus"
                    @click="getDayInfo(date2[0], date2[1], channel2)"
                    >查询</el-button
                >
            </div>
            <el-table
            ...
            >
                    ...
                    <template slot-scope="props">
                        ...
                        >
                            ...
                            <el-form-item label="影片金币价格">
                                <span
                                    >{{ props.row.movieGoldCoinPrice }}元</span
                                >
                            </el-form-item>
                        </el-form>
                    </template>
                ...
                <el-table-column prop="channelName" label="官方推广组">
                </el-table-column>
                <el-table-column prop="userNum" label="注册用户">
                </el-table-column>
                <el-table-column prop="androidNum" label="android用户">
                </el-table-column>
                <el-table-column prop="iosNum" label="ios用户">
                </el-table-column>
                <el-table-column prop="passionNum" label="推广数">
                </el-table-column>
                <el-table-column prop="vipUserNum" label="充值总数">
                </el-table-column>
                <el-table-column prop="payRention" label="付费率">
                </el-table-column>
                <el-table-column prop="todayNum" label="次留">
                </el-table-column>
                <el-table-column prop="threeNum" label="三留">
                </el-table-column>
                <el-table-column prop="sevenNum" label="七留">
                </el-table-column>
                <el-table-column prop="fourteenthNum" label="十四留">
                </el-table-column>
                <el-table-column prop="thirtyNum" label="三十留">
                </el-table-column>
...
export default {
    ...
    methods: {
        selectAll(val) {
            ...
            // 用来储存上一次的值，可以进行对比
            const oldVal =
                this.oldOptions.length === 1 ? [] : this.oldOptions[1];
