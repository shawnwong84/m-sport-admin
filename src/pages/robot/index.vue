<template>
    <div class="info-table">
        ...
        <el-dialog title="机器人管理" :visible.sync="dialogFormVisible"  width="490px">
            <el-form :model="form" ref="form" :rules="rules">
                <el-form-item label="机器人文案" :label-width="formLabelWidth" prop="fakeMsg">
                    <el-input
                            type="textarea"
                            :rows="10"
                            placeholder="请输入内容"
    ...
    export default {
      ...
      data () {
        return {
          ...
          rules: {
            fakeMsg: [
                        { required: true, message: '请输入机器人文案', trigger: 'blur' }
            ]
          }
        }
      },
      ...
      methods: {
        ...
        getInfo () {
          ...
          this.$axios('post', '/backRoom/getRobotMsgList', param).then((res) => {
            if (res.code === 200) {
