<template>
  <div class="info-table">
    ...
    <el-dialog title="红榜管理" :visible.sync="dialogFormVisible"  width="80%">
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item label="红榜标题" :label-width="formLabelWidth"  prop="title">
        ...
        <el-form-item label="专家" :label-width="formLabelWidth"  prop="userName" >
          {{userName}}
          <el-button type="primary"  size="small" @click="openTab2()">选择</el-button>
        </el-form-item>
        <el-form-item label="关联赛事" :label-width="formLabelWidth"  prop="tabName" >
          {{tabName}}
          <el-button type="primary"  size="small" @click="openTab()">选择</el-button>
        </el-form-item>
        <el-form-item label="方案详情" :label-width="formLabelWidth" prop="content">
    ...
    <el-dialog title="专家列表" :visible.sync="dialogFormVisible2"  width="80%">
      <el-table
        ...
        <el-table-column
            ...
            width="130">
          <template slot-scope="scope">
            <el-button type="primary" class="cursor" size="mini" plain @click="checkStarItem2(scope.row)">选中</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        title: [
          { required: true, message: '请输入红榜标题', trigger: 'blur' }
        ]
      },
      headers: {
