<template>
    <div class="info-table">
        ...
        >
            ...
            <el-table-column prop="matchName" width="180" label="赛程标题">
            </el-table-column>
            <el-table-column label="主队名称" width="120" align="center">
                <template slot-scope="scope">
                    <span>{{ scope.row.homeTeam.teamName }}</span>
                </template>
            </el-table-column>
            <el-table-column width="90" label="主队图片">
                <template slot-scope="scope">
            ...
            <el-table-column label="客队名称" width="120" align="center">
                <template slot-scope="scope">
                    <span>{{ scope.row.awayTeam.teamName }}</span>
                </template>
            </el-table-column>
            <el-table-column width="90" label="客队图片">
                <template slot-scope="scope">
            ...
            <el-table-column fixed="right" width="250">
                <template slot-scope="scope">
                    <div class="fx align-items cursor">
                        ...
                        <div
                            class="ml-10"
                            @click="updateConfig(scope.row.id, 'good')"
                        >
                            <el-button
                                type="primary"
                                class="cursor"
                    ...
                    <div class="fx align-items cursor mt-10">
                        ...
                        <div
                            class="ml-10"
                            @click="updateConfig(scope.row.id, 'neutral')"
                        >
                            <el-button
                                type="primary"
                                class="cursor"
            ...
            <el-form :model="form" ref="form">
                <el-form-item label="队伍名称" :label-width="formLabelWidth">
                    <el-radio
                        ...
                        :label="homeTeam.id"
                        @change="checkDy(1)"
                        >{{ homeTeam.teamName }}</el-radio
                    >
                    <el-radio
                        v-model="form.teamId"
                        :label="awayTeam.id"
                        @change="checkDy(2)"
                        >{{ awayTeam.teamName }}</el-radio
                    >
                </el-form-item>
                <el-form-item
                    label="队伍主次"
        ...
        >
            ...
            >
                ...
                <el-table-column prop="matchShortName" label="消息名称">
                </el-table-column>
                <el-table-column prop="teamName" label="队伍名称">
                </el-table-column>
                <el-table-column prop="homeAway" label="队伍类型">
                </el-table-column>
