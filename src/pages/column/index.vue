  ...
  <div class="info-table">
    <div class="fx align-items justify-between mt-15 mb-15 ml-10 mr-10">
      ...
      <div class="fx align-items">
        ...
        <div class="ml-10" @click="dialogFormVisible = true"><el-button type="primary"  size="small" icon="el-icon-plus" @click="add">增加</el-button></div>
      </div>
    </div>
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="update cursor w-32 bg-f2" @click="update(scope.row)"><img src="../../assets/image/update-q.png"></div>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <el-dialog title="角色管理" :visible.sync="dialogFormVisible"  width="388px">
      <el-form :model="form" ref="form" :rules="rules">
          <el-form-item label="栏目序号" :label-width="formLabelWidth" prop="sort">
            <el-input type="age" v-model.number="form.sort" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="栏目描述" :label-width="formLabelWidth" prop="menuDes">
          <el-input v-model="form.menuDes" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        <el-form-item label="关联路径" :label-width="formLabelWidth" prop="jumpPath">
          <el-input v-model="form.jumpPath" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
    ...
    data () {
      ...
      return {
        ...
        rules: {
          ...
          type: [
            { required: true, message: '请输入栏目类型', trigger: 'change' }
          ]
        },
    ...
    methods: {
      ...
      updateSumbit () {
        this.$refs['form'].validate((valid) => {
          if (valid) {
            let param = this.form
            this.$axios('post', '/sys/menu/updateMenu', param).then((res) => {
              if (res.code === 200) {
                this.dialogFormVisible = false
                this.$refs['form'].resetFields()
                this.getInfo()
