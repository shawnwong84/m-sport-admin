  ...
  <div class="info-table">
    <div class="fx align-items justify-between mt-15 mb-15 ml-10 mr-10">
      ...
      <div class="fx align-items" style="margin-right: 60px">
        ...
        <div class="ml-10">
          <el-select v-model="sortType" placeholder="请选择" size="small" style="width: 80px;">
    ...
    <div class="fx align-items fx-end mt-15 mb-15 ml-10 mr-10">
      <div class="fx align-items">
        ...
        <div class="ml-10">
          <el-select v-model="hotAnchor1" placeholder="请选择" size="small" style="width: 80px;">
            <el-option value="0" label="否"></el-option>
            <el-option value="1" label="是"></el-option>
          </el-select></div>
        <div class="ml-10">
          <el-select v-model="type" placeholder="请选择" size="small" class="w-150">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div v-if="scope.row.avatarUrl">
            <img  :src="scope.row.avatarUrl" width="100px" height="55px"/>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="fx cursor">
            ...
            <div class="ml-10"  @click="detele(scope.row.id)"><img src="../../assets/image/delete-q.png"></div>
          </div>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="用户管理" :visible.sync="dialogFormVisible"  width="490px">
      <el-form>
        <el-form-item label="用户头像" label-width="160px" prop="userCover">
        ...
        <el-form-item label="主播昵称" label-width="160px" prop="nickName" v-if="userType === 1">
          <el-input v-model="nickName"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="是否热门" label-width="160px" prop="hotAnchor" v-if="userType === 1">
          <el-radio  v-model="hotAnchor" :label="0">否</el-radio>
          <el-radio  v-model="hotAnchor" :label="1">是</el-radio>
        </el-form-item>
        <el-form-item label="热度" label-width="160px" prop="hotNum" v-if="userType === 1">
          <el-input v-model.number="hotNum"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="主播描述" label-width="160px" prop="desc" v-if="userType === 1">
          <el-input v-model="desc"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
      </el-form>
    ...
    methods: {
      ...
      detele (id) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          this.$axios('post', '/backUser/delUserById', param).then((res) => {
            if (res.code === 200) {
              this.$message({
                type: 'success',
                message: '删除成功!'
      ...
      getInfo () {
        ...
        this.$axios('post', '/backUser/backGetUserList', param).then((res) => {
          if (res.code === 200) {
