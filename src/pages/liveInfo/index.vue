<template>
    <div class="info-table">
        ...
        <div class="mr-10 fx align-items fx-end">
            <div>房间名：</div>
            <div>
                <el-input placeholder="房间名" size="small" v-model="roomName">
                </el-input>
            </div>
            ...
            <el-button type="primary" size="small" @click="getInfo(1)"
                >查询</el-button
            >
        </div>
        <el-table
        ...
        >
            ...
            <el-table-column prop="matchTime" label="比赛时间" align="center">
            </el-table-column>
            <!--<el-table-column
              prop="receivedGold"
              label="收获金币"
            ...
            <el-table-column label="下播时间" align="center">
                <template slot-scope="scope">
                    <span>{{ scope.row.endTime }}</span>
                </template>
            </el-table-column>
            <el-table-column prop="liveTime" label="直播时长" align="center">
            </el-table-column>
            <el-table-column
                prop="userAccessNum"
                label="直播间用户量"
...
export default {
    ...
    methods: {
        getInfo() {
            ...
            this.$axios('post', '/V1/record/getRoomHostRecordList', param).then(
                (res) => {
                    if (res.code === 200) {
