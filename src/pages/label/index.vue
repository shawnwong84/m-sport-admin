  ...
  <div class="info-table">
    <div class="fx align-items justify-between mt-15 mb-15 ml-10 mr-10">
      ...
      <div class="fx align-items">
        ...
        <div class="ml-10" @click="getInfo(1)"><el-button type="primary"  size="small" class="el-icon-search">查询</el-button></div>
      </div>
    </div>
    <el-table
        :data="tableData"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div v-if="scope.row.roomCover">
            <img  :src="scope.row.roomCover" width="100px" height="55px"/>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="cursor">
            <div class="update w-32 bg-f2" @click="update(scope.row)">
              <el-button type="primary" class="cursor"
                         size="mini" plain >修改房间配置</el-button>
            </div>
            <div class="mt-10"  @click="addRoomHistoryMsg(scope.row.huanXinRoomId)">
              <el-button type="primary" class="cursor"
                         size="mini" plain >新增历史消息</el-button>
            </div>
            <div class="mt-10"  @click="updateRoomHistoryMsg(scope.row.huanXinRoomId)">
              <el-button type="primary" class="cursor"
                         size="mini" plain >修改历史消息</el-button>
            </div>
<!--            <div class="ml-10" @click="update(scope.row,2)"><img src="../../assets/image/delete-q.png"></div>-->
    ...
    <el-dialog title="房间管理" :visible.sync="dialogFormVisible"  width="50%">
      <el-form :model="form" ref="form">
        <el-form-item label="房间封面" :label-width="formLabelWidth" prop="roomCover">
        ...
        <el-form-item label="房间名" :label-width="formLabelWidth" prop="roomName">
          <el-input v-model.number="form.roomName"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="播放链接" :label-width="formLabelWidth" prop="liveUrl">
          <el-input  type="textarea"
                     :rows="10" v-model="liveUrl"  disabled></el-input>
        </el-form-item>
        <el-form-item label="热度" :label-width="formLabelWidth" prop="hotNum">
          <el-input v-model.number="form.hotNum"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="主播公告" :label-width="formLabelWidth" prop="announcement">
          <el-input v-model.number="form.announcement"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="是否推荐" :label-width="formLabelWidth" prop="recommend">
          <el-radio  v-model="form.recommend" :label="0">不推荐</el-radio>
          <el-radio  v-model="form.recommend" :label="1">推荐</el-radio>
        </el-form-item>
        ...
        <el-form-item label="是否热门" :label-width="formLabelWidth" prop="showHot">
          <el-radio  v-model="form.showHot" :label="0">否</el-radio>
          <el-radio  v-model="form.showHot" :label="1">是</el-radio>
        </el-form-item>
        <el-form-item label="是否正在直播" :label-width="formLabelWidth" prop="type">
          <el-radio  v-model="form.type" :label="0">不在</el-radio>
          <el-radio  v-model="form.type" :label="1">在</el-radio>
        </el-form-item>
        <el-form-item label="关联赛程" :label-width="formLabelWidth"  prop="matchName" >
          {{matchName}}
          <el-button type="primary"  size="small" @click="openMatch()">选择</el-button>
        </el-form-item>
        <el-form-item label="QQ群" :label-width="formLabelWidth" prop="qqGroupNum">
          <el-input v-model.number="form.qqGroupNum"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="QQ" :label-width="formLabelWidth" prop="qqNum">
          <el-input v-model.number="form.qqNum"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="微信" :label-width="formLabelWidth" prop="wxNum">
          <el-input v-model.number="form.wxNum"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
        <el-form-item label="是否开启聊天假消息" :label-width="formLabelWidth" prop="enableFakeChat">
          <el-radio  v-model="form.enableFakeChat" :label="0">禁用</el-radio>
          <el-radio  v-model="form.enableFakeChat" :label="1">启用</el-radio>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="赛程列表" :visible.sync="dialogFormVisible1"  width="80%">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.homeTeam.teamIcon">
              <img  :src="scope.row.homeTeam.teamIcon" width="100px" height="55px"/>
            </div>
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.awayTeam.teamIcon">
              <img  :src="scope.row.awayTeam.teamIcon" width="100px" height="55px"/>
            </div>
          </template>
        </el-table-column>
        <el-table-column
    ...
    <el-dialog title="历史消息" :visible.sync="dialogFormVisible2"  width="490px">
      <el-form>
        <el-form-item label="发送人" :label-width="formLabelWidth" prop="senderName">
          <el-input v-model="senderName"  style="width: 200px;margin-right: 10px;"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editRoomHistoryMsg">确 定</el-button>
      </div>
    </el-dialog>
    <el-dialog title="历史消息列表" :visible.sync="dialogFormVisible3"  width="80%">
    <el-table
        :data="historyMsg"
        style="width: 100%;"
        header-cell-class-name="bg-f5">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="fx cursor">
            <div class="update w-32 bg-f2" @click="updateRoomMsg(scope.row)"><img src="../../assets/image/update-q.png"></div>
            <div class="ml-10" @click="deleteMsg(scope.row)"><img src="../../assets/image/delete-q.png"></div>
          </div>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    editRoomHistoryMsg () {
      ...
      this.$axios('post', '/backRoom/editRoomHistoryMsg', param).then((res) => {
        if (res.code === 200) {
          this.dialogFormVisible2 = false
          this.getRoomHistoryMsgList(1)
        }
    ...
    getRoomHistoryMsgList (num) {
      ...
      this.$axios('post', '/backRoom/getRoomHistoryMsgList', param).then((res) => {
        if (res.code === 200) {
