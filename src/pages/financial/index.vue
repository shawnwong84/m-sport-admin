<template>
    <div class="info-table">
        ...
        >
            ...
            <el-table-column prop="fakeLike" label="点赞数量">
            </el-table-column>
        ...
        >
            <el-form :model="form" ref="form" :rules="rules">
                ...
                >
                    {{ anchorName }}
                    <el-button type="primary" size="small" @click="openTab(2)"
                        >选择</el-button
                    >
                </el-form-item>
                <el-form-item
                ...
                >
                    {{ tabName }}
                    <el-button type="primary" size="small" @click="openTab(1)"
                        >选择</el-button
                    >
                </el-form-item>
                <el-form-item
        ...
        >
            ...
            >
                ...
                <el-table-column label="是否显示在搜索top上">
                    <template slot-scope="scope">
                ...
                <el-table-column fixed="right">
                    <template slot-scope="scope">
                        <el-button
                            ...
                            size="mini"
                            plain
                            @click="checkhotExpert(scope.row)"
                            >选中</el-button
                        >
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getInfo() {
            ...
            this.$axios('post', '/articleBack/getArticleList', param).then(
                (res) => {
                    if (res.code === 200) {
        ...
        getArticleTagList() {
            ...
            this.$axios('post', '/articleBack/getArticleTagList', param).then(
                (res) => {
                    if (res.code === 200) {
        ...
        updateInfo() {
            let param = this.form;
            this.$axios('post', '/articleBack/editArticleInfo', param).then(
                (res) => {
                    if (res.code === 200) {
                        this.$message({
                            type: 'success',
