<template>
    <div class="info-table">
        ...
        >
            ...
            <el-table-column prop="matchName" width="150" label="赛程名称">
            </el-table-column>
            <el-table-column label="主队vs客队" width="150" align="center">
                <template slot-scope="scope">
                    <span>{{ scope.row.homeVsAway }}</span>
                </template>
            </el-table-column>
            <el-table-column label="专家名称" width="150" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="下注位" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column prop="homeWinOdds" align="center" label="主胜倍率">
            </el-table-column>
            <el-table-column prop="awayWinOdds" align="center" label="客胜倍率">
            </el-table-column>
            <el-table-column prop="flatOdds" align="center" label="平倍率">
            </el-table-column>
            <el-table-column
                prop="createTime"
                width="200"
        ...
        >
            <el-form :model="form" ref="form">
                ...
                >
                    <el-input
                        v-model.number="form.homeWinOdds"
                        style="width: 200px; margin-right: 10px"
                    ></el-input>
                </el-form-item>
                <el-form-item
                ...
                >
                    <el-input
                        v-model.number="form.awayWinOdds"
                        style="width: 200px; margin-right: 10px"
                    ></el-input>
                </el-form-item>
                <el-form-item
        ...
        addSumbit() {
            this.$refs['form'].validate((valid) => {
                if (valid) {
                    ...
                    let param = this.form;
                    this.$axios('post', '/match/editHotRankInfo', param).then(
                        (res) => {
                            if (res.code === 200) {
                                this.$message({
                                    type: 'success',
