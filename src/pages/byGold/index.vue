<template>
    <div class="info-table">
        ...
        >
            ...
            <el-table-column prop="rechargeAmount" label="购买金币">
            </el-table-column>
            ...
            <el-table-column label="所属渠道">
                <template slot-scope="scope">
                    ...
                    <span
                        v-if="scope.row.channelId && scope.row.channelId !== 0"
                        >渠道{{ scope.row.channelId }}</span
                    >
                </template>
            </el-table-column>
            <el-table-column width="200" label="购买时间">
                <template slot-scope="scope">
...
export default {
    ...
    methods: {
        getInfo(num) {
            ...
            this.$axios('post', '/recharge/goldRechargeList', param).then(
                (res) => {
                    if (res.code === '0') {
