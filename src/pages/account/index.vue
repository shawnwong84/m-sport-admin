<template>
  <div class="info-table">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="fx cursor">
            ...
            <div class="ml-10"><el-button type="primary" class="cursor" size="mini" plain @click="update(scope.row, 3)">修改密码</el-button></div>
          </div>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="账号管理" :visible.sync="dialogFormVisible"  width="388px">
      <el-form :model="form" ref="form" :rules="rules">
        <el-form-item label="用户名称" :label-width="formLabelWidth" prop="username" v-if="!isShowPwd">
          <el-input v-model="form.username" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        <el-form-item label="用户密码" :label-width="formLabelWidth" prop="password" v-if="isShowPwd  || isAdd">
          <el-input v-model="form.password" autocomplete="off" style="width: 217px;"></el-input>
        </el-form-item>
        <el-form-item label="角色名称" :label-width="formLabelWidth" prop="roleId" v-if="!isShowPwd">
          <el-select v-model="form.roleId" placeholder="请选择角色名称" :disabled="disabled">
            <el-option v-for="(item,index) in roleList" :key="index" :value="item.id" :label="item.roleName"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
